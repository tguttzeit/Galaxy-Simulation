...
class SimulationGUI(QtWidgets.QWidget):
    ...
    def __init__(self, nr_of_entries, delta_t):
    ...
    def setup(self):
        ...
        self.planetary_system = Galaxy(self.nr_of_entries, self.nr_of_entries_changed)
...
def _main(argv):
    ...
    simulation_gui = SimulationGUI(nr_of_planets, delta_t)
    simulation_gui.show()
    sys.exit(app.exec_())
